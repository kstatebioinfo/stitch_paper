...
%% Between version 3.0 \cite{Beetle2008} and version 5.0 (Table 2) of the \textit{Tribolium} genome 1.03 Mb of sequence was added for a length of 160.74 Mb in 2,240 scaffolds after linking with Atlas-Link (version 0.01) and gap filling with GapFiller (version 1.10).
