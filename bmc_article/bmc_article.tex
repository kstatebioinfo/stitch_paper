...
\section*{Figures}
  \begin{figure}[h!]
  \caption{\csentence{Detailed steps for running stitch.pl.}
...
\begin{figure}[h!]
	\caption{\csentence{Extremely small negative gap length for \textit{in silico} CMAP of scaffold 81.}
		Two XMAP alignments for \textit{in silico} CMAP of scaffold 81 are shown. BNG CMAPs (blue with molecule coverage shown in dark blue) align to the \textit{in silico} CMAPs of scaffolds (green with contigs overlaid as translucent colored squares). Scaffolds 79-83 were placed within ChLG 5 and scaffolds 99-103 were placed with ChLG 7 by the \textit{Tribolium} genetic map. However half of scaffold 81 aligns with its assigned ChLG and the other half with ChLG 7.}
\end{figure}
\begin{figure}[h!]
